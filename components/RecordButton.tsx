    ...
    <div className="absolute bottom-28 left-1/2 transform -translate-x-1/2 z-50">
      <button
        ...
        className={`
          ...
          ${isRecording ? 'bg-red-500 scale-110 animate-pulse' : 'bg-brand-600 hover:bg-brand-500 hover:scale-105'}
      ...
      {isRecording && (
        <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-black/70 text-white text-xs px-2 py-1 rounded whitespace-nowrap">
          Listening...
        </div>
      )}
    </div>
